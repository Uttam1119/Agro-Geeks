            ...
            echo "
                ...
                <div class='card pb-1 pl-1 pr-1 pt-0' style='height:542px'>
                    ...
                    <div class='card-body pb-0'>
                        ...
                        <p class='card-text mb-2 font-weight-bold'>मूल्य:- $product_price रुपये/किलोग्राम</p>
                        <div class='row'>
                            <div class='col-1 col-xl-3 col-lg-2 col-md-2 col-sm-2'></div>
                            <div class='col-12 col-xl-6 col-lg-6 col-md-6  col-sm-12'>
                                <a href='../BuyerPortal2/bhome.php?add_cart=$product_id' class='btn btn-warning border-secondary mr-1  ' style='color:black ;font-weight:50px;'>कार्ट में ऐड करे<img src='carticons.png' height='20px'></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                echo "
                    <div class='productbox'>
                        ...
                        <div>
                            ...
                            <p><b>मूल्य:- $price रुपये/किलोग्राम</b></p>
                        </div>
