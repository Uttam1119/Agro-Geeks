...
<body>
    ...
    <div class="box">
        <form action="BuyerForgotPassword.php" method="post">
            <h3>पासवर्ड भूल गए</h3>
     
            <br>
            <input type="phonenumber"  class="inp" name="phonenumber" placeholder="फ़ोन नंबर" required><br>
            <input type="text" class="inp" name="pan" placeholder="पैन नंबर" required><br>

            <input type="password" class="inp" name="password" placeholder="पासवर्ड" required><br>
            <input type="password" class="inp" name="confirmpassword" placeholder="पासवर्ड की पुष्टि कीजिये" required><br><br>
            <span style=" display:block;  margin-bottom: .75em; "></span>
        <br>
            <input type="submit" name="register" value="पासवर्ड अपडेट करें">
        </form>
    </div>
