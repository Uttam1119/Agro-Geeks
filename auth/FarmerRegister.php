...
<main class="my-form">
		<div class="cotainer">
			<div class="row justify-content-center">
				<div class="col-md-8">
					<div class="card">
						<div class="card-header" style="background-color:#292b2c"><h4 style="font-style:bold;color:goldenrod">किसान पंजीकरण<h4></div>
						<div class="card-body border border-dark">
							<form name="my-form" action="FarmerRegister.php" method="post">
								...
								<div class="form-group row">
									...
									<div class="col-md-6">
										<input type="text" id="phone_number" class="form-control border border-dark" name="phonenumber" placeholder="फ़ोन नंबर" required>
									</div>
								</div>
                                ...
                                <div class="form-group row">
                                    <label for="states" class="col-md-4 col-form-label text-md-right"><b><i class="fas fa-globe-americas mr-2"></i>राज्य</b></label>
                                    <div class="col-md-6">
                            ...
                            <option value="WEST BENGAL">वेस्ट बंगाल</option>
                                ...
                                <div class="form-group row">
                                    <label for="states" class="col-md-4 col-form-label text-md-right"><b><i class="fas fa-globe-americas mr-2"></i>ज़िला</b></label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
									<label for="account2" class="col-md-4 col-form-label text-md-right"><i class="fas fa-pencil-alt mr-2"></i><b>
पैन कार्ड नंबर</b></label>
									<div class="col-md-6">
