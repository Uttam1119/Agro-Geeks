...
<body>
    ...
    <div class="box">
        <form action="FarmerForgotPassword.php" method="post">
            ...
            <br>
            <input type="phonenumber"class="inp" name="phonenumber" placeholder="फ़ोन नंबर"><br>
            <input type="text" class="inp" name="pan" placeholder="पैन नंबर"><br>

            <input type="password" class="inp" name="password" placeholder="पासवर्ड" required><br>
            <input type="password" class="inp" name="confirmpassword" placeholder="पासवर्ड की पुष्टि कीजिये" required><br>
