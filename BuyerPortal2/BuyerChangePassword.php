    ...
    <div class="box">
        <form action="" method="post">
            <table align="center">
                ...
                <tr align="center">
                    <td>
                        <label><b>वर्तमान पासवर्ड :</b></label>
                    </td>
                    <td>
                        <input type="password" name="currentpassword" placeholder="वर्तमान पासवर्ड" /> <br>
                    </td>
                </tr>
                <tr align="center">
                    <td>
                        <label><b>नया पासवर्ड :</b></label>
                    </td>
                    <td>
                        <input type="password" name="newpassword" placeholder="नया पासवर्ड" /> <br>
                    </td>
                </tr>
                <tr align="center">
                    <td>
                        <label><b>पासवर्ड फिर से दर्ज करें :</b></label>
                    </td>
                    <td>
                        <input type="password" name="confirmpassword" placeholder="नए पासवर्ड की पुष्टि करें" /> <br>
                    </td>
                </tr>
                <tr>
                    <td colspan=2>
