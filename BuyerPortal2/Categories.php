               ...
               <div class="row   p-2">
                    <div class="col-12 col-xl-3 col-lg-3 col-md-12 col-sm-12">
                         <div class="text-center">
                              ...
                              " style="color: #FFD700 ">अपना क्षेत्र चुनें</h4>
                         </div>
                    </div>
                    <div class="col-6 col-xl-3 col-lg-3 col-md-6 col-sm-6 p-0 States">
                         ...
                         <option value="0">--राज्य चुनें--</option>
                            <option value="ANDAMAN & NICOBAR ISLANDS">अंडमान और निकोबार द्वीप समूह</option>
                            ...
                            <option value="DAMAN AND DIU">दमन और दीव</option>
                            ...
                            <option value="JAMMU AND KASHMIR">जम्मू और कश्मीर</option>
                             <!-- check -->
                            <option value="JHARKAND">झारखण्ड</option>
                            ...
                            <option value="MANIPUR">मणिपाल</option>
                            ...
                            <option value="UTTARANCHAL">उत्तरांचल</option>
                            <option value="WEST BENGAL">वेस्ट बंगाल</option>
                    ...
                    <div class="col-6 col-xl-3 col-lg-3 col-md-6 col-sm-6 districts">
                         ...
                         <select class="p-2 ml-5 shadow-lg" name="districtInput" id="district" style="border-radius: 6px; border-color: #FFD700 ">
                              <option>जिला चुनें</option>
                         </select>

                    </div>
                    <div class="col-12 col-xl-3 col-lg-3 col-md-12 col-sm-12 go">
                         <button class='btn btn-border-secondary mx-5 ' name='go' type='submit' style='color:black ;float:right;font-weight:50px; background-color: black;color:#FFD700'>फ़िल्टर</button>
                    </div>
               </div>
               ...
               if (isset($_GET['type'])) {
                ...
                <div class='card pb-1 pl-1 pr-1 pt-0' style='height:542px'>
                    ...
                    <div class='card-body pb-0'>
                        <div class='row'>
                            ...
                            <div class='col-12 col-xl-6 col-lg-6 col-md-6 col-sm-12'>
                                <div class='input-group mb-1'>
                                    <div class='input-group-prepend'>
                                        <span class='input-group-text bg-warning border-secondary p-1' style='color:black;' id='inputGroup-sizing-default' placeholder='1'><b>मात्रा</b></span>
                                    </div>
                        ...
                        <p class='card-text mb-2 font-weight-bold'>कीमत:- $product_price रुपये/किलोग्राम</p>
                        <div class='row'>
                            <div class='col-1 col-xl-3 col-lg-2 col-md-2 col-sm-2'></div>
                            <div class='col-12 col-xl-6 col-lg-6 col-md-6  col-sm-12'>
                              <button class='btn btn-warning border-secondary mr-1 ' name='cart' type = 'submit' style='color:black ;font-weight:50px;'>कार्ट में जोड़ें<img src='carticons.png' height='20px'></button>
                            </div>
                        </div>
                    </div>
                       </form>
