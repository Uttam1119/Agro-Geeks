...
<nav class="navbar navbar-expand-xl ">
    ...
    <form action="checkout.php" method="post">
        ...
        <div class="container mt-2">
            <div class="text">
                <br>
                <h3 style="font-family:Georgia, 'Times New Roman', Times, serif">अपना पता जांचें </h3>
            </div>
            ...
            <form>
                <div class=" float-none float-sm-none float-md-none float-lg-right float-xl-rightcheckout mr-0 p-2 mb-5   " style="border-radius:5%;">
                    <h4 style="font-family: sans-serif"><b>कुल योग = रु. <?php echo $_SESSION['grandtotal']; ?> </b></h4>
                </div>
                <div class="input-group mt-2 hey ">
                    <div class="input-group-prepend ">
                        <span class="input-group-text" style="background-color:#292b2c;color:goldenrod">डिलिवरी का पता</span>
                    </div>
        ...
        <div class="container mt-5">
            <div class="text">
                <h3 style="font-family:Georgia, 'Times New Roman', Times, serif">अपने आइटम जांचें </h3>
            </div>
            <hr style="margin-top:-0.5%">
            <table class="table">
                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <td data-label=">Delivery options">
                                            <select class="custom-select custom-select" name="delivery">
                                                <option selected value="Farmer">किसान</option>
                                                <option value="Buyer">क्रेता</option>
                                                <option value="Courier">संदेशवाहक</option>
                                            </select>
                                        </td>
                                    </tr>
                                </tbody>
        ...
        <div class="container mt-5">
            <div class="text">
                <h3 style="font-family:Georgia, 'Times New Roman', Times, serif">अपना भुगतान मोड चुनें</h3>
            </div>
            <hr style="margin-top:-0.5%">
    ...
    <div class="float-none float-sm-none float-md-none float-lg-right float-xl-right goback ">
        <a href="cartpage.php"><button type="button" class="btn btn-lg  border border-dark  " style="font-size:22px;color:black;background-color:#FFD700;margin-left:-8%;">
                <i class="fas fa-arrow-left"></i> वापस जाओ </button></a>
    </div>
    </div>
