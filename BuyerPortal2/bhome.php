...
<body>
    ...
    <div class="container">
        <div class="text-center">
            ...
            <h1 id="headings" class="guard"><span><b>ताज़ा फल </b></span>
            </h1>
        </div>
    ...
    <div class="container">
        <div class="text-center">
            <!-- <h2 id="headings" class="destext">Fresh fruits</h2> -->
            <h1 id="headings" class="guard"><span><b>ताज़ी सब्जियां
 </b></span>
            </h1>
        </div>
    ...
    <div class="container">
        ...
        <div class="text-center">
            <h1 id="headings" class="longguard"><span><b>पूरे भारत में सर्वाधिक बिकने वाले उत्पाद </b></span>
            </h1>
        </div>
        <br>
        <div class="row">
