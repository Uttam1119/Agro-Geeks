...
<head>
	...
	<title>Agro-Geeks Homepage</title>
...
<body>
	...
	<div class="instaid">
		<div class="text"><a href="#" style="color:black;">@AgroGeeks</a></div>
		<div class="gmailid">
			<a href="#" class="hypher" style="color:black;">agrogeeks6@gmail.com</a></div>

	</div>


	<div class="copy">
		<h5 style="test-align:center; padding-top:40px;margin-left:650px; background-color:'grey';">Copyright &copy; 2022 by www.Agro-Geeks.com</h5>
	</div>
</body>
