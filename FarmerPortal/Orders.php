...
<table>
          ...
          <tr><td>
            ...
            <td>
                <div class="grp2">
                    ...
                    <div class="col3 t1"><b>Delivery Mode</b></div>
                    <div class="col4">
     ...
     <div class="morefooter">
          ...
          <div class="call">
               ...
               <a href="#" style="color:black;">+91-7667011877</a>
          </div>
     ...
     <div class="instaid">
          <div class="text"><a href="#" style="color:black;">@Agro-Geeks</a></div>

          <div class="gmailid">
               <a href="#" class="hypher" style="color:black;">agro-geeks6@gmail.com</a>
          </div>

     </div>
     <div class="copy">
          <h5 style="test-align:center; padding-top:40px;margin-left:650px; background-color:'grey';">Copyright &copy; 2023 by www.Agro-Geeks.com</h5>
     </div>
