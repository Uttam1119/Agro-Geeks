...
<body>
     ...
     <nav class="navbar navbar-expand-xl ">
          ...
          <div class=content_item>
               <label style="font-size :30px; text-shadow: 1px 1px 1px gray;"><b>सभी प्रोडक्ट</b></label>
               <?php
               include("../Includes/db.php");
               if (isset($_SESSION['phonenumber'])) {

                    echo "<a href='InsertProduct.php'>
                    <button class='btn btn-warning btn-lg p-3 m-3 font-weight-bold'>नया उत्पाद जोड़ें <i class='fas fa-plus-square p-2 fa-1x'></i>
                    </button>
                    </a>";
               } else {
