...
<head>
    ...
    <title>Farmer - Rental Products</title>
...
<div class="features container">
                <br>
                <h1 style="font-weight: bold;color:black; text-align:center">उपलब्ध मशीनें किराए पर लेने के लिए</h1>
                <br>
                <br>
                <div class="card-deck row text-center" style="display: flex; flex-wrap: wrap;">
                    ...
                    <div class="card mx-2 my-2">
                          <p class="aligncenter">
                               <img class="card-img-top image" src="../Images/rental/harvester.jpg" alt="Card image cap" width="250px" height="200px">
                          </p>
                          <div class="card-body">
                               <h4 class="card-title font-weight-bold">फ़सल काटने की मशीन</h4>
                               <br>
                               <h5 class="card-text"> किराये की लागत: 2.5k/माह </h5>
                          </div>
                     </div>
                    </a>
                     <a href="rental.php ">
                     <div class="card ">
                          <p class="aligncenter">
                               <img class="card-img-top image" src="../Images/rental/tractor.jpg" alt="Card image cap" width="250px" height="200px">
                          </p>
                          <div class="card-body">
                               <h4 class="card-title font-weight-bold">ट्रैक्टर</h4>
                               <br>
                               <h5 class="card-text"> किराये की लागत: 2.5k/माह </h5>
                          </div>
                     </div>
                     </a>
                     <a href="rental.php"><div class="card ">
                          <p class="aligncenter">
                               <img class="card-img-top image" src="../Images/rental/plough.webp" alt="Card image cap" width="250px" height="200px">
                          </p>
                          <div class="card-body">
                               <h4 class="card-title font-weight-bold">हल</h4>
                               <br>
                               <h5 class="card-text"> किराये की लागत: 2.5k/माह </h5>
                          </div>
                     </div></a>
                     ...
                     <div class="card my-2">
                          <p class="aligncenter">
                               <img class="card-img-top image" src="../Images/rental/rotary.jpeg" alt="Card image cap" width="250px" height="200px">
                          </p>
                          <div class="card-body">
                               <h4 class="card-title font-weight-bold">रोटरी</h4>
                               <br>
                               <h5 class="card-text"> किराये की लागत: 2.5k/माह </h5>
                          </div>
                     </div>
