 ...
 <body>
      ...
      <body>
                ...
                <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
                     <div class="carousel-inner">
                          <div class="carousel-item active">
                               <img class="d-block w-100 resizing" src="../Images/Homepage/first.jpeg" alt="First slide">
                          </div>
                          <div class="carousel-item">
                               <img class="d-block w-100 resizing" src="../Images/Homepage/vegetable.jpg" alt="Second slide">
                          </div>
                          <div class="carousel-item">
                               <img class="d-block w-100 resizing" src="../Images/Homepage/nomore.jpg" alt="Third slide">
                          </div>
                     </div>
           ...
           <div class="features container">
                <h1 style="font-weight: bold;color:black; text-align:center">भोपाल में गोदाम</h1>
                <div class="card-deck row text-center" style="display: flex; flex-wrap: wrap;">
                     <div class="card">
                     <iframe src="https://www.google.com/maps/embed?pb=!1m16!1m12!1m3!1d103633.60698806841!2d77.47746958664989!3d23.26587889636381!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!2m1!1sCold%20Storage!5e0!3m2!1sen!2sin!4v1680035664846!5m2!1sen!2sin" width="1110" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
...
<!-- 
           <div class="map container">
               <h1>Warehouses in Bhopal</h1>
           <iframe src="https://www.google.com/maps/embed?pb=!1m16!1m12!1m3!1d103633.60698806841!2d77.47746958664989!3d23.26587889636381!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!2m1!1sCold%20Storage!5e0!3m2!1sen!2sin!4v1680035664846!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
           </div> -->

           <br><br>
           <div class="features container">
                <h1 style="font-weight: bold;color:black; text-align:center">अन्य सुविधाएँ</h1>
                <div class="card-deck row text-center" style="display: flex; flex-wrap: wrap;">
                     <div class="card">
                          <p class="aligncenter">
                          ...
                          <div class="card-body">
                               <h4 class="card-title font-weight-bold">एसएमएस सिस्टम </h4>
                               <br>
                               <h5 class="card-text">एसएमएस के माध्यम से अपने उत्पादों को अपलोड और संपादित करें </h5>
                          </div>
                     </div>
                     <div class="card">
                          <p class="aligncenter">
                          ...
                          <div class="card-body">
                               <h4 class="card-title font-weight-bold">क्रेता कनेक्शन</h4>
                               <br>
                               <h5 class="card-text">खरीदार के साथ सीधे संपर्क में रहें ताकि उनकी जरूरत को पूरा किया जा सके</h5>
                          </div>
                     </div>
                     <div class="card">
                          <p class="aligncenter">
                          ...
                          <div class="card-body">
                               <h4 class="card-title font-weight-bold">किसान समूह गठन
</h4>
                               <br>
                               <h5 class="card-text">अपना खुद का समुदाय बनाने वाले अन्य किसानों से संपर्क करें जहां आप मदद मांग सकते हैं</h5>
                          </div>
                     </div>
                </div>
           </div>
