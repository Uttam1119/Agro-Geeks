                    ...
                    echo "<div class='container'>
                                   <div class='row'>
                                        ...
                                        <div class='col-md-6 blackgoldie'>
                                             ...
                                             <h3  style='color:white;padding:7px;'>" . $product_price . ".00 रुपये/किलोग्राम</h3>
                                             <hr/>
                                             <div class='row'>
                                             ...
                                             <div class='row'>
                                                  <div class='col-md-12 text-center'>
                                                       <h3 style='color:white;padding:7px;'><span class='monospaced'>उत्पाद स्टॉक: " . $product_stock . " किलोग्राम" . "</span><h3>
                                                  </div>
                                             </div>
                                             <div class='row' style='padding:7px;'>
                                                  <div class='row text-center ml-4 mt-3' >
                                                       <i class='fa fa-truck fa-2x' aria-hidden='true' style='color:goldenrod;'> </i>
                                                       <h3 style='color:white;'>   उत्पाद वितरण: " . $del . "<h3>
                                                  </div>
                                             </div>

                                             <div class='row' style='padding:7px; margin-bottom:15px;' >
                                                  <div class='col-12 col-xl-6 col-lg-6 col-md-6 col-sm-12 aligncenter'> <a href='EditProduct.php?id=$prod_id' class='btn btn-warning border-secondary' style='color:black'><b>उत्पाद एडिट करें</b></a></div>
                                                  <div class='col-12 col-xl-6 col-lg-6 col-md-6 col-sm-12 aligncenter'> <a href='Transactions.php' class='btn btn-warning border-secondary' style='color:black'><b>मेरा लेन-देन</b></a></div>
                                             </div>
                                        </div>         
                                   </div>
                              </div>
                              <div class='container'>
                                   <div class='desc'>
                                        <div class='row'>
                                             <div class='col-md-12'>
                                             <h3><span class='monospaced'><u><b>उत्पाद वर्णन:-</b></u></span><h3>
                                             </div>
                                        </div>
                                        <div class='row'>
                                                  <div class='col-md-12'>
