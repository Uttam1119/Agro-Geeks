...
<body>
    ...
    <div class="just">
        <a href="farmerHomepage.php"> <img src="agro-logo.ico" alt=""></a>
    </div>
    ...
    <div class="box">
        <form action="EditProfile.php" method="post">
            <table align="center">
                ...
                <tr align="center">
                    <td>
                        <label><b>ज़िला :</b></label>
                    </td>
                    <td>
                         <select name="district" id="district"><option>जिला चुनें</option></select>
                    </td>
                </tr>

                <tr align="center">
                    <td>
                        <label><b>बैंक खाता :</b></label>
                    </td>
                    <td>
                ...
                <tr colspan=2>
                    <td colspan=2>
                        <input type="submit" name="confirm" value="पुष्टि करना">
                    </td>
                </tr>
            </table>
        </form>
        ...
        <div class="again">
            <a href="ChangePassword.php"><button class="say">पासवर्ड बदलें</button></a>
        </div>
